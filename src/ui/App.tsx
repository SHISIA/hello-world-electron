    ...
    <>
        <div className="min-h-screen flex fle-col items-center justify-center py-6 px-4">
            <div className="grid md:grid-cols-2 items-center gap-10 max-w-6xl max-md:max-w-md w-full">
                ...
                <form className="max-w-md md:ml-auto w-full px-4">
                    <div className="flex justify-start pb-4 w-full text-left">
                        <img alt="logo" src={icon} className="w-16 h-16" />
                    </div>
                    ...
                    <div className="flex justify-center pb-4 w-full text-center">
                        <p className="text-sm mt-5 text-slate-500">Don't have an account
                            <a href="javascript:void(0);"
                               className="text-blue-600 font-medium hover:underline ml-1">Register
                            here</a>
                        </p>
                    </div>
                </form>
                ...
                <div className="justify-center text-center">
                    <img src={logo} alt="pictuure of a man standing"/>
                    {/*<div className="bg-white mt-1 h-52 z-10">*/}
                    {/*    /!*<h3 className=" text-center text-2xl">Welcome to Your Productivity Hub</h3>*!/*/}
                    {/*    <ul className="list-disc list-inside text-gray-800 text-left pt-10">*/}
                    {/*        <li className="text-md mt-2 text-slate-500 leading-relaxed ">*/}
                    {/*            Effortless login.</li>*/}
                    {/*        <li className="Create selector mt-0 text-slate-500 leading-relaxed ">*/}
                    {/*            Instant access.</li>*/}
                    {/*        <li className="Create selector mt-0 text-slate-500 leading-relaxed ">*/}
                    {/*            Smooth, secure sign-in experience.</li>*/}
                    {/*    </ul>*/}
                    {/*</div>*/}
                </div>
            </div>
